...
__all__ = ['minimax_generator_loss', 'minimax_discriminator_loss', 'least_squares_generator_loss',
           'least_squares_discriminator_loss', 'mutual_information_penalty', 'wasserstein_generator_loss',
           'wasserstein_discriminator_loss', 'wasserstein_gradient_penalty', 'dragan_gradient_penalty',
           'auxiliary_classification_loss', 'energy_based_generator_loss', 'energy_based_discriminator_loss',
           'energy_based_pulling_away_term', 'boundary_equilibrium_generator_loss',
